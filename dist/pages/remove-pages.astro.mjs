import { c as createComponent, r as renderComponent, a as renderTemplate, F as Fragment, b as addAttribute, u as unescapeHTML } from '../chunks/astro/server_Bokrf6dK.mjs';
import 'piccolore';
import { $ as $$BaseLayout, h as howToSchema, T as ToolWrapper } from '../chunks/ToolWrapper_DoAP8VYa.mjs';
...
const errors = {
  ...
  FILE_TOO_LARGE: {
    message: "The file is too large. Please choose a smaller file, or use our compress-pdf tool to reduce the file size.",
  ...
  FILE_CORRUPT: {
    message: "The file is corrupt and cannot be processed. Please choose a valid file.",
    code: "ERR_FILE_CORRUPT"
  },
  MAX_FILES_EXCEEDED: {
    message: "You have exceeded the maximum number of files allowed. Please delete some files and try again.",
  ...
  MAX_DAILY_USAGE: {
    message: "You’ve reached your daily usage limit. Please upgrade your plan to continue using this feature without interruption.",
...
const $$RemovePages = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": item.title, "description": item.description, "seoTitle": item.seoTitle, "to": item.to, "seoConfig": seoConfig, "lang": lang }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "ToolWrapper", ToolWrapper, { "client:load": true, "tools": tools, "data": item, "lang": lang, "errors": errors, "edit_page": edit_page, "pages": edit_page.pages, "page": edit_page.page, "downloadFile": downloadFile, "features": item.features, "howTo": howToSchema, "seoTitle": item.title, "to": currentRoute, "adBlockerContent": adBlockerContent, "client:component-hydration": "load", "client:component-path": "/home/pdfequips.com/remove-pages/components/ToolWrapper", "client:component-export": "ToolWrapper" })} `, "head": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": ($$result3) => renderTemplate(_a || (_a = __template([' <script type="application/ld+json">', '<\/script> <script type="application/ld+json">', '<\/script> <link rel="canonical"', "> "])), unescapeHTML(JSON.stringify(websiteSchema)), unescapeHTML(JSON.stringify(howToSchema)), addAttribute(`https://www.pdfequips.com${item.to}`, "href")) })}` })}`;
}, "/home/pdfequips.com/remove-pages/src/pages/remove-pages.astro", void 0);

const $$file = "/home/pdfequips.com/remove-pages/src/pages/remove-pages.astro";
const $$url = "/remove-pages/remove-pages";
